...
TestingTime::TestingTime(Settings2 *settings)
{
    target_size = settings->s_target_size;
    screen_res = settings->s_screen_res;
    time_limit = settings->s_time_limit;
    Initialization();
}

void TestingTime::Initialization()
{
...
void TestingTime::Begin()
{
    this->show();
}

void TestingTime::StartCountdown()
{
